package com.techolution.user.exception;

import com.techolution.user.payload.ApiResponse;
import com.techolution.user.payload.ExceptionResponse;
...
public class RestControllerExceptionHandler {
	...
	public ResponseEntity<ApiResponse> resolveException(UserApiException exception) {
